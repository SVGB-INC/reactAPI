...
namespace reactAPI.Controllers
{
    ...
    [ApiController]
    public class ADashboardController : ControllerBase
    {
        private readonly IConfiguration _configuration;

        public ADashboardController(IConfiguration configuration)
        {
        ...
        {
            string query = @"SELECT TOP 10 comps.uID,
                            [comp_user],comps.comp_name,[comp_venue],[comp_create_date],   [comp_participants]
