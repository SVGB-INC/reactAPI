    ...
    public class CompetitionController : ControllerBase
    {
        ...
        public JsonResult Get()
        {
            string query = @"SELECT [uID],[comp_user],[comp_name],[comp_venue],[comp_create_date],[comp_participants]
                            ,[comp_winners],[comp_prizes],[comp_type],[comp_code],[comp_winner_names],[comp_status],[comp_start_date] from dbo.dt_Comps";
        ...
        public JsonResult Post(Competition comp)
        {
            string query = @"INSERT INTO dbo.dt_Comps([comp_user],[comp_name],[comp_venue],[comp_create_date],[comp_participants]
                            ,[comp_winners],[comp_prizes],[comp_type],[comp_code],[comp_winner_names], [comp_status], [comp_file],[comp_list])
                            ...
                            + @"','" + comp.CompType + @"','" + comp.CompCode + @"','" + comp.CompWinnerNames + @"','Pending','" + comp.CompFile + @"','" + comp.CompList + @"')";
